...
const PlayerTable = ({ playerNames }) => {
 ...
 const Lobby = ( {count} ) => {
  ...
  useEffect(()=>{
    ...
    },[canStart,roomNo,totalPlayers, playerNames])
  ...
  <div className="Lobby-middle">
    ...
    <div className="rules-container">
        ...
        <div className="rules-para">
         ...
         <p>Artists earn points for correct guesses of their drawing.
            Guessers earn points for correctly identifying the word.</p> 
